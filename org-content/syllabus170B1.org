...
|------------------+-----------------------+--------+------------|
|                  | Number                | Points | % of Total |
|------------------+-----------------------+--------+------------|
| Midterm          | 1                     |    100 |            |
| Final exam       | 1                     |    200 |            |
| Homework/Labs    | 14 (lowest 2 dropped) |     10 |            |
| Quizzes          | 13 (lowest 1 dropped) |     10 |            |
| Participation    | 25 (lowest 4 dropped) |      8 |            |
| Final assignment | 1                     |    150 |            |
|------------------+-----------------------+--------+------------|
...
** TODO Labs
There are two graded in-class labs throughout the semester. A lab makeup will only be
allowed for an excused absence as defined below; please contact Prof.
Alexander.
